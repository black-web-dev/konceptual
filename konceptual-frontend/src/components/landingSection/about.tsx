...
export default function AboutSectioin({ size }: { size: any }) {
  return (
    <div className='landing-section h-full w-full'>
      <div className='background-image absolute top-0 left-0 h-full w-full bg-[url("/images/landing/about.png")] bg-cover bg-center'></div>
      ...
      <div className='center-title absolute mx-auto my-auto h-full w-full flex flex-col items-center justify-center'>
        <div className='flex flex-col items-center justify-center w-[700px]'>
          ...
          <div className='title my-6 flex flex-col items-center justify-center text-5xl font-bold text-white'>
            <div>¿Qué es un Marketplace de NFTs?</div>
          </div>
          <div className='detail text-center text-white'>
            Si no conoces mucho sobre los Marketplace de NFTs, aquí te comentamos un poco de que tratan así como la terminología comúnmente utilizada.
          </div>
        </div>
      </div>
